...
typedef uint8_t RFIDKEY[6];

extern const RFIDKEY DEFAULT_KEY;
...
////////////////////////////////////////////////////////////////////////
  ...
  void reset();
  void read();
  void done(); // dummy to keep in line with MFRC522 lib
  String tag( uint32_t expireAfter = 0); // expired in msec, 0 means 'never'
  bool readValue( uint16_t index, String& value);
  bool writeValue( uint16_t index, String value);

////////////////////////////////////////////////////////////////////////

  void begin( uint8_t irq, uint8_t reset);
  ...
  // ISO14443A functions
  bool readPassiveTargetID( uint8_t cardbaudrate, uint8_t *uid, uint8_t *uidLength, uint32_t timeout = 0); //timeout 0 means no timeout - will block forever.
/*
  uint8_t AsTarget();
...
////////////////////////////////////////////////////////////////////////
  ...
  RFIDKEY m_key = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
  uint8_t m_uid[4] = { 0, 0, 0, 0 };
  String  m_tag;
  int     m_timeout;
  long    m_stamp;
};
